...
app.post('/sendEmail', (req, res) => {
    ...
    axios.post('https://connect.mailerlite.com/api/email', {
        html: message,
        subject: subject,
        from: {
            name: senderName,
